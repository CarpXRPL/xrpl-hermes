...
def main() -> int:
    print(json.dumps({
        ...
        "SafeReplacement": "Run `python3 -m scripts.xrpl_tools build-clawback ...` with reviewed parameters to produce unsigned JSON, hand it to a compatible user-owned signer, then verify the validated result with `tx-info`.",
